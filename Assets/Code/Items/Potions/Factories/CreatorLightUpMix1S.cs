...
{
    public class CreatorLightUpMix1S : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new LightUpMix1S(Convert.ToInt32(itemData.itemsParameters["val"]),
