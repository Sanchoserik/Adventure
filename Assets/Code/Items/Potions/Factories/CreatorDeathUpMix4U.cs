...
{
    public class CreatorDeathUpMix4U : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new DeathUpMix4U(Convert.ToInt32(itemData.itemsParameters["val"]),
