...
{
    public class CreatorDarknessUpMix1S : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new DarknessUpMix1S(Convert.ToInt32(itemData.itemsParameters["val"]),
