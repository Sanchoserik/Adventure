...
{
    public class CreatorWaterUpMix3G : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new WaterUpMix3G(Convert.ToInt32(itemData.itemsParameters["val"]),
