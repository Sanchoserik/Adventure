...
{
    public class CreatorLightUpMix2M : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new LightUpMix2M(Convert.ToInt32(itemData.itemsParameters["val"]),
