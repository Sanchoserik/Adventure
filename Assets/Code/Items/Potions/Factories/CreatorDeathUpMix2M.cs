...
{
    public class CreatorDeathUpMix2M : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new DeathUpMix2M(Convert.ToInt32(itemData.itemsParameters["val"]),
