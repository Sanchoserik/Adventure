...
{
    public class CreatorDarknessUpMix4U : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new DarknessUpMix4U(Convert.ToInt32(itemData.itemsParameters["val"]),
