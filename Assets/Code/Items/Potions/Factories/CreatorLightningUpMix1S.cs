...
{
    public class CreatorLightningUpMix1S : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new LightningUpMix1S(Convert.ToInt32(itemData.itemsParameters["val"]),
