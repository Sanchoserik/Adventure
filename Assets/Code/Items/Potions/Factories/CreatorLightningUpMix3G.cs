...
{
    public class CreatorLightningUpMix3G : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new LightningUpMix3G(Convert.ToInt32(itemData.itemsParameters["val"]),
