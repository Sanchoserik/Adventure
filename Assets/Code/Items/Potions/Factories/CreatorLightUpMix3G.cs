...
{
    public class CreatorLightUpMix3G : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new LightUpMix3G(Convert.ToInt32(itemData.itemsParameters["val"]),
