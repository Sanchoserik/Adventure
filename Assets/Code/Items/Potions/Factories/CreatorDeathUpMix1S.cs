...
{
    public class CreatorDeathUpMix1S : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new DeathUpMix1S(Convert.ToInt32(itemData.itemsParameters["val"]),
