...
{
    public class CreatorEarthUpMix2M : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new EarthUpMix2M(Convert.ToInt32(itemData.itemsParameters["val"]),
