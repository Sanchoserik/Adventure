...
{
    public class CreatorDeathUpMix3G : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new DeathUpMix3G(Convert.ToInt32(itemData.itemsParameters["val"]),
