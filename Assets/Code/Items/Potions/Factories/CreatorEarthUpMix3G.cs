...
{
    public class CreatorEarthUpMix3G : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new EarthUpMix3G(Convert.ToInt32(itemData.itemsParameters["val"]),
