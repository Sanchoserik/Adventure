...
{
    public class CreatorLightningUpMix2M : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new LightningUpMix2M(Convert.ToInt32(itemData.itemsParameters["val"]),
