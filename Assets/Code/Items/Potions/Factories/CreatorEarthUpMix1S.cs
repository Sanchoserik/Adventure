...
{
    public class CreatorEarthUpMix1S : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new EarthUpMix1S(Convert.ToInt32(itemData.itemsParameters["val"]),
