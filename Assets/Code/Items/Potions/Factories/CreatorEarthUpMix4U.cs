...
{
    public class CreatorEarthUpMix4U : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new EarthUpMix4U(Convert.ToInt32(itemData.itemsParameters["val"]),
