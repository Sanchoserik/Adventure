...
{
    public class CreatorDarknessUpMix2M : IItemFactory
    {
        public A_Item createItem(ItemsData itemData) => new DarknessUpMix2M(Convert.ToInt32(itemData.itemsParameters["val"]),
