...
namespace Assets.Code.Skills.Tactics
{
    ...
    public class SkillTacticalRetreat : A_Skill
    {
        ...
        public SkillTacticalRetreat(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
        ...
        public override void levelXInit(SkillsData sData, int level)
        {
            ...
            decreaseTPower = Convert.ToInt32(sData.skillValues[level]["decreaseTpower"]);
        }
    }
}
