...
namespace Assets.Code.Skills.Assassin
{
    ...
    public class SkillGehenna : A_Skill
    {
        ...
        public SkillGehenna(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
        ...
        public override void levelXInit(SkillsData sData, int level)
        {
            ...
            mainFireDmg = Convert.ToInt32(sData.skillValues[level]["FireDmg"]);
            othersFireDmg = Convert.ToInt32(sData.skillValues[level]["FireDmgOthers"]);
