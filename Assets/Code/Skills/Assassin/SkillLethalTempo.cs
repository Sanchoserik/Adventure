...
namespace Assets.Code.Skills.Assassin
{
    ...
    {
        int comboModIncr;
        int damageToHeroIncr;
        int sDuration;

        public SkillLethalTempo(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
