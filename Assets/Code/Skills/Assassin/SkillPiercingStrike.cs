...
namespace Assets.Code.Skills.Assassin
{
    ...
    public class SkillPiercingStrike : A_Skill
    {
        ...
        public SkillPiercingStrike(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
        ...
        public override void levelXInit(SkillsData sData, int level)
        {
            ...
            defIgnoreVal = Convert.ToInt32(sData.skillValues[level]["DeffIgnoreVal"]);
