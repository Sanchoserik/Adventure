...
{
    [Serializable]
    public class SkillRegeneration : A_Skill
    {
        int regenerationVal;
        int sDuration;
        
        public SkillRegeneration(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
        ...
        public override void levelXInit(SkillsData sData, int level)
        {
            ...
            regenerationVal = Convert.ToInt32(sData.skillValues[level]["Healing"]);
