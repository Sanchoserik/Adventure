...
namespace Assets.Code.Skills.Warrior
{
    ...
    public class SkillCounterAttack : A_Skill
    {
        ...
        public SkillCounterAttack(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
        ...
        public override void levelXInit(SkillsData sData, int level)
        {
            ...
            counterAttackChance = Convert.ToInt32(sData.skillValues[level]["val1"]);
        }
    }
}
