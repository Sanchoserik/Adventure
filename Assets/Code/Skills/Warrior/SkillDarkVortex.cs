...
namespace Assets.Code.Skills.Warrior
{
    ...
    public class SkillDarkVortex : A_Skill
    {
        ...
        public SkillDarkVortex(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
