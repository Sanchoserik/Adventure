...
namespace Assets.Code.Skills.Warrior
{
    ...
    public class SkillTripleCut : A_Skill
    {
        ...
        public SkillTripleCut(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
