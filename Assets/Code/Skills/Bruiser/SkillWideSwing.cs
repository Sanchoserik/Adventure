...
{
    [Serializable]
    public class SkillWideSwing : A_Skill
    {
        int physDmg;
        int bleedDmg;
        int sDuration;

        public SkillWideSwing(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
        ...
        public override void levelXInit(SkillsData sData, int level)
        {
            ...
            bleedDmg = Convert.ToInt32(sData.skillValues[level]["BleedPhysDmg"]);
