...
namespace Assets.Code.Skills.Bruiser
{
    ...
    public class SkillBlocking : A_Skill
    {
        ...
        public SkillBlocking(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
        ...
        public override void levelXInit(SkillsData sData, int level)
        {
            ...
            blockVal = Convert.ToInt32(sData.skillValues[level]["val1"]);
        }
    }
}
