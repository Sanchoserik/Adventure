...
namespace Assets.Code.Skills.Bruiser
{
    ...
    public class SkillDelayedDeath : A_Skill
    {
        ...
        public SkillDelayedDeath(string sName, string sUnlocker, string[] sToUnlock, bool isAvailableForLearning) : base(sName, sUnlocker, sToUnlock, isAvailableForLearning)
        {
